...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = 'D:/affair/college/ISTD/TMP/model_data/yolox_s.pth'
    # model_path      = ''
    #------------------------------------------------------#
    ...
    #   weight_decay    权值衰减，可防止过拟合.sgd:5e-4
    ...
    #   获得图片路径和标签
    #----------------------------------------------------#
    DATA_PATH = "D:/affair/college/ISTD/TMP/DAUB/"
    train_annotation_path = 'D:/affair/college/ISTD/TMP/DAUB/coco_train_DAUB.txt'
    val_annotation_path = 'D:/affair/college/ISTD/TMP/DAUB/coco_val_DAUB.txt'
    ...
    model = Tasanet(num_classes=1, num_frame=num_frame)
    weights_init(model)
    if model_path != '':
        #------------------------------------------------------#
        #   权值文件请看README，百度网盘下载
    ...
    if True:
        ...
        if local_rank == 0:
            eval_callback   = EvalCallback(model, input_shape, class_names, num_classes, val_lines, log_dir, Cuda, \
                                            eval_flag=eval_flag, period=eval_period, num_frame=num_frame)
        else:
            eval_callback   = None

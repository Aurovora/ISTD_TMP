...
if __name__ == "__main__":
    train_dataset = seqDataset("D:/affair/college/ISTD/TMP/DAUB/coco_train_DAUB.txt", 256, 5, 'train')
    # train_dataset = seqDataset("D:/affir/college/ISTD/TMP/DAUB/coco_train_DAUB.txt", 256, 5, 'train')
